...
class DepositExpandedPage extends HookConsumerWidget {
  static const name = "DepositExpandedPage";
  const DepositExpandedPage({super.key});
  ...
  Widget build(BuildContext context, ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Deposit Offers"),
        centerTitle: false,
      ),
      body: Padding(
            ...
            SliverToBoxAdapter(
              child: switch (depositCategories) {
                AsyncData(:final value) =>
                  ChipSelector<SupabaseDepositsCategory>(
